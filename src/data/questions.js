...
const questions = {
  "Security Principles": {
   ...
   "ISO/IEC 19249": [
        {
          id: 1,
          question: "Which architectural principle ensures that each set of related components is isolated into a controlled group?",
          options: [
            "Encapsulation",
            "Domain Separation",
            "Virtualization",
        ...
        {
          id: 3,
          question: "Which principle is illustrated by a clock object offering an increment() method instead of exposing a seconds variable?",
          options: [
            "Encapsulation",
            "Layering",
            "Redundancy",
        ...
        {
          id: 5,
          question: "Which principle improves security boundaries and allows detonation of malware in a safe environment?",
          options: [
            "Encapsulation",
            "Layering",
            "Virtualization",
        ...
        {
          id: 9,
          question: "Which design principle promotes managing all authentication and related functions through one dedicated service?",
          options: [
            "Least Privilege",
            "Attack Surface Minimisation",
            "Centralized General Security Services",
      ...
      "Zero Trust versus Trust but Verify": [
        ...
        {
          id: 6,
          question: "Which security model assumes that every user or device could be an adversary until proven otherwise?",
          options: [
            "Trust but Verify",
            "Zero Trust",
            "Defense-in-Depth",
            "Integrity-first Access",
          ],
          answerIndex: 1,
        }
      ],
      "Threat Vs Risk": [
        ...
        {
          id: 4,
          question: "If a database system has a known vulnerability and exploit code is released, what does that represent?",
          options: [
